...
describe Board do
    ...
    it 'should completed a box when i mark the four sides' do
        testMovement1 = Movement.new(1,'up')
        testMovement2 = Movement.new(1,'down')
        testMovement3 = Movement.new(1,'right')
        testMovement4 = Movement.new(1,'left')
        @movements = [testMovement1, testMovement2, testMovement3, testMovement4]
        @board.verify(@movements)
        expect(@board.player2.score). to be 1
    end
